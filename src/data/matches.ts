...
export const MATCHES: SeedMatch[] = [
  ...
  // 32avos de final — cuadro oficial FIFA 2026 (post fase de grupos)
  ...
  { external_id: 74, home: "GER", away: "PAR", phase: "r32", scheduled_at: "2026-06-29T20:30:00Z", venue: "Gillette Stadium", city: "Boston", label: "Alemania vs Paraguay" },
  { external_id: 76, home: "BRA", away: "JPN", phase: "r32", scheduled_at: "2026-06-29T16:00:00Z", venue: "NRG Stadium", city: "Houston", label: "Brasil vs Japón" },
  { external_id: 75, home: "NED", away: "MAR", phase: "r32", scheduled_at: "2026-06-30T01:00:00Z", venue: "Estadio BBVA", city: "Monterrey", label: "Países Bajos vs Marruecos" },
  { external_id: 78, home: "CIV", away: "NOR", phase: "r32", scheduled_at: "2026-06-30T16:00:00Z", venue: "AT&T Stadium", city: "Dallas", label: "Costa de Marfil vs Noruega" },
  { external_id: 77, home: "FRA", away: "SWE", phase: "r32", scheduled_at: "2026-06-30T21:00:00Z", venue: "MetLife Stadium", city: "New York", label: "Francia vs Suecia" },
  { external_id: 79, home: "MEX", away: "ECU", phase: "r32", scheduled_at: "2026-07-01T01:00:00Z", venue: "Estadio Azteca", city: "Ciudad de México", label: "México vs Ecuador" },
  { external_id: 80, home: "ENG", away: "COD", phase: "r32", scheduled_at: "2026-07-01T16:00:00Z", venue: "Mercedes-Benz Stadium", city: "Atlanta", label: "Inglaterra vs Congo DR" },
  { external_id: 82, home: "BEL", away: "SEN", phase: "r32", scheduled_at: "2026-07-01T20:00:00Z", venue: "Lumen Field", city: "Seattle", label: "Bélgica vs Senegal" },
  { external_id: 81, home: "USA", away: "BIH", phase: "r32", scheduled_at: "2026-07-02T00:00:00Z", venue: "Levi's Stadium", city: "San Francisco", label: "Estados Unidos vs Bosnia" },
  { external_id: 84, home: "ESP", away: "AUT", phase: "r32", scheduled_at: "2026-07-02T19:00:00Z", venue: "SoFi Stadium", city: "Los Angeles", label: "España vs Austria" },
  { external_id: 83, home: "POR", away: "CRO", phase: "r32", scheduled_at: "2026-07-02T23:00:00Z", venue: "BMO Field", city: "Toronto", label: "Portugal vs Croacia" },
  { external_id: 85, home: "SUI", away: "ALG", phase: "r32", scheduled_at: "2026-07-03T03:00:00Z", venue: "BC Place", city: "Vancouver", label: "Suiza vs Argelia" },
  { external_id: 88, home: "AUS", away: "EGY", phase: "r32", scheduled_at: "2026-07-03T17:00:00Z", venue: "AT&T Stadium", city: "Dallas", label: "Australia vs Egipto" },
  { external_id: 86, home: "ARG", away: "CPV", phase: "r32", scheduled_at: "2026-07-03T22:00:00Z", venue: "Hard Rock Stadium", city: "Miami", label: "Argentina vs Cabo Verde" },
  { external_id: 87, home: "COL", away: "GHA", phase: "r32", scheduled_at: "2026-07-04T01:30:00Z", venue: "Arrowhead Stadium", city: "Kansas City", label: "Colombia vs Ghana" },
